...
// Note: 'status' is the key for conditional rendering
const initialSeats = [
    { id: 'A1', number: 1, status: 'booked', price: 100 },
    { id: 'A2', number: 2, status: 'available', price: 100 },
    { id: 'A3', number: 3, status: 'available', price: 100 },
    { id: 'A4', number: 4, status: 'available', price: 100 },
    { id: 'B1', number: 5, status: 'available', price: 100 },
    { id: 'B2', number: 6, status: 'booked', price: 100 },
    { id: 'B3', number: 7, status: 'available', price: 100 },
    { id: 'B4', number: 8, status: 'available', price: 100 },
];
